...
const SingleChat = ({ setChatHome, personDetails, messages, messageSocket, setMessages, zp }) => {

    console.log(personDetails, messages, 'persond eeeeeeeeeee');
    ...
    useEffect(() => {
        if (personDetails.personDetails) {
            getChats(user._id, personDetails.personDetails._id).then(({ data }) => {
                if (data.data) {
            ...
            <div className="right-0 top-0 flex flex-col flex-grow w-[100%] bg-white shadow-xl rounded-lg overflow-hidden">
                <div className="flex p-1 mt-1">
                    ...
                    <a className="inline-flex items-start mr-3" href="#0">
                        <img className="rounded-full" src={personDetails.personDetails?.Image ?? 'https://www.pngitem.com/pimgs/m/117-1176598_female-student-png-image-indian-college-student-png.png'} width="48" height="54" alt="no" />
                    </a>
                    <div className="pr-1">
