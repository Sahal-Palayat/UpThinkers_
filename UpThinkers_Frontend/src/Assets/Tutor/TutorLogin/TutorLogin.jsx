    ...
    return (
        <div className="h-screen  bg-gray-100 overflow-hidden text-gray-900 flex justify-center">
            ...
            <div className="w-full  bg-white shadow sm:rounded-lg flex h-full  justify-center flex-1">
                ...
                <div className="flex-1 text-center hidden lg:flex bg-no-repeat " style={{ backgroundImage: "url('https://assets-global.website-files.com/650355070f73b7b0891ec935/6595826f27305f540ef6e5cc_6504bb16851001e8456c8989_63c8423c983faf514e3e5ec8_prepare.jpeg')" ,height: '100vh', backgroundSize: 'cover', backgroundPosition: 'center' }}>
