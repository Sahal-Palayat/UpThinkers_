...
import { axiosApiAdmin, axiosApiTutor } from '../../../Services/axios';
...
const AdminRevenuePage = () => {
    ...
    useEffect(() => {
        const fetchDetails = async () => {
            try {
                const { data } = await axiosApiAdmin.get('/getrevuenuadmin');
                setDetails(data);
                console.log(data);
            } catch (error) {
    ...
    return (
        <div>
           <AdminSidebar/>
           <AdminNavbar/>
            <div className="lg:w-[80%] lg:ml-72">
                <main className="mt-10">
                    <div className="grid mb-4 pb-10 px-8 mx-4 rounded-3xl bg-gray-100 border-4 border-customBlue">
                                    ...
                                    <div className="grid grid-cols-12 gap-6 mt-5">
                                        ...
                                        <a className="transform hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white" href="#">
                                            <div className="p-5">
                                                ...
                                                <div className="ml-2 w-full flex-1">
                                                    <div>
                                                        <div className="mt-3 text-3xl font-bold leading-8">{details.tutorsCount}</div>
                                                        <div className="mt-1 text-base text-gray-600">Total Tutors</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
