    ...
    return (
        <div>
            ...
            <div
                ...
                className="h-40 w-full mt-1 flex items-center justify-center"
            >
                ...
                <section id="Projects"
                    ...
                    {course.length > 0 && course.map((course, index) => (
                        ...
                        <div key={index}>
                            ...
                            <div  onClick={() => navigate('/coursedetails', { state: { course: course } })} class="w-72 cursor-pointer bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
                                <p >
