            ...
            <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
                ...
                <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
                    <div className="w-full lg:w-6/12">
                        <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">We are here to make e-learning accessible and engaging for children.
                        </h2>
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6">
                            It is well known that a reader can be distracted by the content on a page while looking at its layout.
                            We are dedicated to providing e-learning courses primarily focused on children, ensuring they gain comprehensive knowledge about the tech field.
                            By engaging children with interactive and informative content, we strive to foster a deep understanding and passion for technology. Our platform is designed to nurture young tech enthusiasts, providing them with the tools and skills they need to innovate and excel. We aim to inspire the next generation of tech leaders,
                            encouraging them to dream big and follow in the footsteps of visionaries like Elon Musk.</p>
                    </div>
                    <div className="w-full lg:w-6/12">
                ...
                <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
                    ...
                    <div className="sm:block hidden">
                        <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">20+ Users</p>
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                    </div>
                </div>
                ...
                <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
                    <div className="w-full lg:w-6/12">
                        ...
                        <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">At our e-learning platform, we believe in the transformative power of technology and education. Our mission is to empower young minds with the knowledge
                            and skills they need to thrive in an increasingly digital world.
                            By providing interactive and engaging e-learning courses focused primarily on children, we aim to cultivate a deep passion for technology from an early age.</p>
                        <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10">We are dedicated to inspiring young learners to explore their potential and pursue their dreams. By equipping them with critical thinking skills and hands-on experience, we aim to help them become future tech pioneers. Our vision is a world where every child has the opportunity to understand and shape technology, ultimately making a significant impact on the world.                       </p>
                    </div>
                    <div className="w-full lg:w-6/12">
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
                            ...
                            <div className="flex p-4 shadow-md">
                                ...
                                <div className="">
                                    ...
                                    <p className="mt-2 font-normal text-base leading-6 text-gray-600">Our team blends technology and education to create outstanding e-learning experiences for children. We are committed to inspiring the tech leaders of tomorrow.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex p-4 shadow-md">
                                ...
                                <div className="">
                                    ...
                                    <p className="mt-2 font-normal text-base leading-6 text-gray-600">Our board includes experienced professionals in technology and education. They guide our platform to ensure exceptional learning experiences for future tech leaders.
                                        .</p>
                                </div>
                            </div>
                ...
                <div class="py-20 bg-gray-50">
                            <div class="container mx-auto px-6 md:px-12 xl:px-32">
                                <div class="mb-16 text-center">
                                    <h2 class="mb-4 text-center text-2xl text-gray-900 font-bold md:text-4xl">UpThinkers leaderships</h2>
                                    <p class="text-gray-600 lg:w-8/12 lg:mx-auto">UpThinkers itself not only on award-winning technology, but also on the talent of its people of some of the brightest minds and most experienced executives in business.</p>
                                </div>
                                <div class="grid gap-12 items-center md:grid-cols-3">
                                    <div class="space-y-4 text-center">
                                        <img class="w-64 h-64 mx-auto object-cover rounded-xl md:w-40 md:h-40 lg:w-64 lg:h-64"
                                            src="./pic 1.jpg" alt="woman" loading="lazy" width="640" height="805"/>
                                            <div>
                                                <h4 class="text-2xl">Sahal Palayat</h4>
                                                <span class="block text-sm text-gray-500">CEO-Founder</span>
                                            </div>
                                    </div>
                                    <div class="space-y-4 text-center">
                                        <img class="w-64 h-64 mx-auto object-cover rounded-xl md:w-48 md:h-64 lg:w-64 lg:h-80"
                                            src="pic 2.jpg" alt="man" loading="lazy" width="1000" height="667"/>
                                            <div>
                                                <h4 class="text-2xl">Sahal Palayat</h4>
                                    ...
                                    <div class="space-y-4 text-center">
                                        <img class="w-64 h-64 mx-auto object-cover rounded-xl md:w-40 md:h-40 lg:w-64 lg:h-64"
                                            src="pic 3.jpg" alt="woman" loading="lazy" width="1000" height="667"/>
                                            <div>
                                                <h4 class="text-2xl">Sahal Palayat</h4>
